...
export default class Listener {
    ...
    _eventListenerNames = [
        ...
        'mouse-click-right',
        'mouse-drag-end',
        'mouse-double-click', // alias of 'mouse-double-click-left'
    ...
    on(eventName, listener) {
        if (this._eventListenerNames.includes(eventName)) {
            ...
            if (eventName === 'mouse-double-click') eventName = 'mouse-double-click-left';
    ...
    _initCursorListeners(canvas, type) { // `type`: either 'mouse' or 'pointer'
        ...
        canvas.addEventListener(`dblclick`, e => {
            const coords = Listener.getInputCoords(e, canvas);
            this._callIfDefined(`mouse-double-click-left`, coords);
        }, false);
    }
